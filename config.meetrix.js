var config = {
  ...
  xhr_user_search_url: 'https://link.meetrix.io:9091/plugins/restapi/v1/users?',
  xhr_restapi: 'https://link.meetrix.io:9091/plugins/restapi/v1/',
  ...
  jitsiMeetConfig: {
    hosts: {
        ...
        muc: 'meet.link.meetrix.io', // FIXME: use XEP-0030
        focus: 'focus.link.meetrix.io',
    },
    ...
    useNicks: false,
    bosh: 'wss://link.meetrix.io:7443/ws/', // FIXME: use xep-0156 for that

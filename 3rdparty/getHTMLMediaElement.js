...
function getHTMLMediaElement(mediaElement, config) {
    ...
    if (config.title) {
        ...
        h2.setAttribute('style', 'position: absolute;color:white;font-size:17px;text-shadow: 1px 1px 5px black;padding:0;margin:0;text-align: left; bottom: 10px; margin-left: 10px; display: block; border: 0;line-height:1.5;z-index:1;');
